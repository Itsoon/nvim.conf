return {
  ...
  cmd = "Telescope",
  -- enabled = function()
  --   return vim.pick.want() == "telescope"
  -- end,
  ...
  keys = {
    ...
    },
    {
      "<leader>sW",
      function()
        require("telescope.builtin").grep_string { cwd = vim.fn.getcwd(), search = vim.fn.getreg "/" }
      end,
      mode = "v",
      desc = "Selection (cwd)",
    },
    ...
    },
    {
      ...
      function()
        require("telescope.builtin").lsp_document_symbols {
          symbols = vim.config.get_kind_filter(),
        }
      end,
      desc = "Goto Symbol",
    },
  ...
  opts = function()
    ...
    local find_files_no_ignore = function()
      ...
      vim.pick("find_files", { no_ignore = true, default_text = line })()
    end
    local find_files_with_hidden = function()
      local action_state = require "telescope.actions.state"
      local line = action_state.get_current_line()
      vim.pick("find_files", { hidden = true, default_text = line })()
    end
